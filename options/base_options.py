...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataset_dir', required=True, help='path of dataset dir')
        parser.add_argument('--gpu_ids', type=str, default='0,1', help='gpu ids for debugging: e.g. 0  0,1,2, 0,2')
        ...
        parser.add_argument('--batch_size', type=int, default=16, help='input batch size on every gpu')
        parser.add_argument('--epoch_load', type=int, default=None, help='which epoch to load?')
